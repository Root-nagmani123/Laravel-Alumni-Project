        ...
        <div class="row align-items-center">
            <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                    <h4 class="mb-4 mb-sm-0 card-title">Add Members</h4> <!--<buttton style="float:right;" class="btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal1"><i class="bi bi-info"></i>Bulk Add</buttton>-->
                    ...
                    <nav aria-label="breadcrumb" class="ms-auto">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">
								...
								<span class="badge fw-medium fs-2 bg-primary-subtle text-primary">
                                    <a class="text-muted text-decoration-none d-flex" href="{{ route('members.bulk_upload_form') }}">
                                        Bulk Add
                                    </a>
                                </span>
...
<div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form enctype="multipart/form-data" method="post" action="{{-- route('members.bulk_upload_members') --}}" id="bulk-upload-form" class="uploader">
