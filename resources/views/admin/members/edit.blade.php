...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="cadre" class="form-control" value="{{ old('cadre', $member->cader) }}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="batch" class="form-control" value="{{ old('batch', $member->batch) }}">
        </div>
