...
<div class="uwaw uw-light-theme gradient-head uwaw-initial paid_widget" id="uw-main">
    <div class="relative second-panel" style="background-color: #792421;margin-bottom:3rem;">
                ...
                <div class="uwaw-features__item reset-feature" id="featureItem-ht-dark"> <button id="dark-btn"
                        ...
                        aria-label="Enable the UserWay screen reader" aria-pressed="false"> <span
                            class="uwaw-features__item__name"> <span class="light_dark_icon"> <input type="checkbox"
                                    class="light_mode uwaw-featugres__item__i" id="checkbox" />
...
<button id="uw-widget-custom-trigger" class="uw-widget-custom-trigger" aria-label="Accessibility Widget"
    data-uw-trigger="true" aria-haspopup="dialog" style="background-color: #792421; margin-bottom:3rem;"><img
...
<div class="d-none d-lg-block position-relative">
    <a href="https://www.lbsnaa.gov.in/footer_menu/contact-us" target="_blank" class="floating-btn d-none d-lg-flex"
        ...
        <span class="chat-text">Contact Us</span>
    </a>
</div>
<style>
.floating-btn {
...
.floating-btn i {
    font-size: 20px;
    margin: 0 auto;
    /* icon center in small state */
    min-width: 50px;
    /* icon area stays visible */
    text-align: center;
}
...
.floating-chat-btn {
    ...
    .floating-chat-btn:hover {
        width: 230px;
        background-color: #792421; /* Optional for contrast */
    }
