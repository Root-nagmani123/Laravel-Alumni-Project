            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav navbar-nav-scroll mx-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle {{ request()->is('library*') ? 'active' : '' }}" href="#"
                            id="libraryDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Library
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="libraryDropdown">
                            <li><a class="dropdown-item" href="https://gsl.lbsnaa.gov.in/" target="_blank">Gandhi Smriti
                                    Library</a></li>
                            <li><a class="dropdown-item" href="https://idpbridge.myloft.xyz/" target="_blank">e-Library
                                    (MyLOFT)</a></li>
                        </ul>
                    </li>
            ...
            <ul class="nav flex-nowrap align-items-center ms-sm-3 list-unstyled">
                <li class="nav-item dropdown ms-2">
                    ...
                    <div class="dropdown-menu dropdown-animation dropdown-menu-end dropdown-menu-size-md p-0 shadow-lg border-0"
                        aria-labelledby="notifDropdown" style="z-index:1060 !important;">
                        <div class="card">
     ...
     data-created-at="{{ $notification->created_at }}">
            ...
            <div class="d-flex align-items-start">
                ...
                <div class="flex-shrink-0">
                    <div class="bg-primary text-white rounded-circle d-flex align-items-center justify-content-center"
                        ...
                        <strong>{{ strtoupper(substr($notification->title ?? 'B', 0, 1)) }}</strong>
                                        ...
                                        break;
                                        case 'broadcast':
                                        $notificationUrl = route('user.broadcastDetails', ['id' =>
                                        ...
                                        break;
                                        case 'birthday':
                                        $notificationUrl = route('user.profile.data', ['id' =>
                                        $notification->source_id]);
                                        break;
                                        default:
                                        $notificationUrl = '#';
                ...
                <li class="nav-item ms-2 dropdown" style="z-index:1060 !important;">
                    <a class="nav-link btn icon-md p-0" href="{{ route('user.profile.data', ['id' => $user->id]) }}"
                    ...
                    <ul class="dropdown-menu dropdown-animation dropdown-menu-end pt-3 small me-md-n3"
                        aria-labelledby="profileDropdown" style="z-index: 1100;">
