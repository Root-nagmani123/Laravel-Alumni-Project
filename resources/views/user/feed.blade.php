                    ...
                    <li>
                        <a href="birthday.html" class="tippy" title="Birthday">
                            <svg class="bar-icon fill-white">
                                <use xlink:href="{{asset('user_assets/svg/icons.svg#cake')}}"></use>
                            </svg>
                        </a>
                    </li>
                    <li class="inner-list">
                        <a href="games.html" class="tippy" title="Games">
                            <svg class="bar-icon fill-white">
                                <use xlink:href="{{asset('user_assets/svg/icons.svg#game-controller')}}"></use>
                            </svg>
                        </a>
                        <span class="count">2</span>
                        <ul>
                            <li>
                                <a href="#"><img src="{{asset('user_assets/images/icon/game/1.jpg')}}" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="{{asset('user_assets/images/icon/game/2.jpg')}}" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="{{asset('user_assets/images/icon/game/3.jpg')}}" alt=""></a>
                            </li>
                        </ul>
                    </li>
                </ul>
            ...
            <ul class="sidebar-icon">
                ...
                <li class="inner-list">
                    ...
                    <ul class="vertical-slide-3 no-arrow">
                        <li>
                            <a href="#"><img src="../user_assets/images/icon/game/1.jpg" alt=""></a>
                        </li>
                        <li>
                            <a href="#"><img src="../user_assets/images/icon/game/2.jpg" alt=""></a>
                        </li>
                        <li>
                            <a href="#"><img src="../user_assets/images/icon/game/3.jpg" alt=""></a>
                        </li>
                        <li>
                            <a href="#"><img src="../user_assets/images/icon/game/4.jpg" alt=""></a>
                        </li>
                    </ul>
                </li>
            </ul>
                ...
                <div class="page-content">
                    ...
                    <div class="content-right">
                        ...
                        <div class="birthday-section">
                            <img src="{{asset('user_assets/images/birthday-bg.jpg')}}" class="img-fluid blur-up lazyload bg-img"
                                alt="birthday">
                            <div class="birthday-top">
                                <div class="title">
                                    <h3>birthday !!!!</h3>
                            ...
                            <div class="birthday-content">
                                <div class="image-section">
                                    <div class="icon">
                                        <img src="{{asset('user_assets/images/icon/cake.png')}}" class="img-fluid blur-up lazyload"
                                            alt="cake">
                                    </div>
                                    <div class="center-profile">
                                        <img src="{{asset('user_assets/images/user-sm/4.jpg')}}"
                                    ...
                                    <div class="slide-2 no-arrow default-space">
                                        <div>
                                            <div class="story-box">
                                                <div class="adaptive-overlay"></div>
                                                <div class="story-bg">
                                                    <img src="{{asset('user_assets/images/game/1.jpg')}}" class="img-fluid bg-img"
                                                        data-adaptive-background='1' alt="">
                                                </div>
                                                <div class="story-content">
                                                    <h6>josephin water</h6>
                                        ...
                                        <div>
                                            <div class="story-box">
                                                <div class="adaptive-overlay"></div>
                                                <div class="story-bg">
                                                    <img src="{{asset('user_assets/images/game/2.jpg')}}" class="img-fluid bg-img"
                                                        data-adaptive-background='1' alt="">
                                                </div>
                                                <div class="story-content">
                                                    <h6>josephin water</h6>
                                        ...
                                        <div>
                                            <div class="story-box">
                                                <div class="adaptive-overlay"></div>
                                                <div class="story-bg">
                                                    <img src="{{asset('user_assets/images/game/3.jpg')}}" class="img-fluid bg-img"
                                                        data-adaptive-background='1' alt="">
                                                </div>
                                                <div class="story-content">
                                                    <h6>josephin water</h6>
                                                    <span class="player"> <img src="../user_assets/images/icon/user-w.png"
                ...
                <div id="accordion" class="friend-list collapse show">
                    <ul>
                        <li class="friend-box user1">
                            <div class="media">
                                <a class="popover-cls user-img" data-bs-toggle="popover" data-placement="bottom"
                                    data-name="paige turner" data-img="{{asset('user_assets/images/user-sm/1.jpg')}}">
                                    <img src="{{asset('user_assets/images/user-sm/1.jpg')}}" class="img-fluid blur-up lazyload bg-img"
                                        alt="user">
                        ...
                        <li class="friend-box user2">
                            <div class="media">
                                <a class="popover-cls user-img" data-bs-toggle="popover" data-placement="bottom"
                                    data-name="bob frapples" data-img="{{asset('user_assets/images/user-sm/2.jpg')}}">
                ...
                <div id="accordion1" class="friend-list collapse show">
                    <ul>
                        <li class="friend-box user3">
                            <div class="media">
                                <a class="popover-cls user-img" data-bs-toggle="popover" data-placement="bottom"
                                    data-name="josephine water" data-img="{{asset('user_assets/images/user-sm/3.jpg')}}">
                                    <img src="{{asset('user_assets/images/user-sm/3.jpg')}}" class="img-fluid blur-up lazyload bg-img"
                                        alt="user">
                                    <span class="available-stats"></span>
                                </a>
                                <div class="media-body">
                        ...
                        <li class="friend-box user4">
                            <div class="media">
                                <a class="popover-cls user-img" data-bs-toggle="popover" data-placement="bottom"
                                    data-name="petey cruiser" data-img="{{asset('user_assets/images/user-sm/4.jpg')}}">
                                    <img src="{{asset('user_assets/images/user-sm/4.jpg')}}" class="img-fluid blur-up lazyload bg-img"
                                        alt="user">
                        ...
                        <li class="friend-box user5">
                            <div class="media">
                                <a class="popover-cls user-img" data-bs-toggle="popover" data-placement="right"
                                    data-name="anna sthesia" data-img="{{asset('user_assets/images/user-sm/1.jpg')}}">
                                    <img src="{{asset('user_assets/images/user-sm/5.jpg')}}" class="img-fluid blur-up lazyload bg-img"
                                        alt="user">
                                    <span class="available-stats online"></span>
                                </a>
                                <div class="media-body">
                        ...
                        <li class="friend-box user6">
                            <div class="media">
                                <a class="popover-cls user-img" data-bs-toggle="popover" data-placement="right"
                                    data-name="paul molive" data-img="{{asset('user_assets/images/user-sm/6.jpg')}}">
                                    <img src="{{asset('user_assets/images/user-sm/6.jpg')}}" class="img-fluid blur-up lazyload bg-img"
                                        alt="user">
                                    <span class="available-stats"></span>
                                </a>
                                <div class="media-body">
                        ...
                        <li class="friend-box user7">
                            <div class="media">
                                <a class="popover-cls user-img" data-bs-toggle="popover" data-placement="right"
                                    data-name="anna mull" data-img="{{asset('user_assets/images/user-sm/7.jpg')}}">
                                    <img src="{{asset('user_assets/images/user-sm/7.jpg')}}" class="img-fluid blur-up lazyload bg-img"
                                        alt="user">
