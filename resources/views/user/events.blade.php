                   ...
                   <div class="card-body">
                       ...
                       <ul class="nav nav-tabs nav-bottom-line justify-content-center justify-content-md-start"
                           ...
                           <li class="nav-item" role="presentation"> <a class="nav-link active" data-bs-toggle="tab"
                                   href="#tab-1" aria-selected="true" role="tab"> All </a> </li>
                           <li class="nav-item" role="presentation"> <a class="nav-link" data-bs-toggle="tab"
                                   href="#tab-2" aria-selected="false" tabindex="-1" role="tab"> Interested </a> </li>
                           <li class="nav-item" role="presentation"> <a class="nav-link" data-bs-toggle="tab"
                                   href="#tab-3" aria-selected="false" tabindex="-1" role="tab"> Not Interested </a>
                           </li>
                           <li class="nav-item" role="presentation"> <a class="nav-link" data-bs-toggle="tab"
                                   href="#tab-4" aria-selected="false" tabindex="-1" role="tab"> Maybe </a> </li>
                       </ul>
                       <!-- Tab content START -->
                                       ...
                                       <div class="card h-100">
                                           <div class="position-relative">
                                               <img class="img-fluid rounded-top"
                                                   src="{{asset('feed_assets/images/events/01.jpg')}}" alt="">
                                               <div
                                               ...
                                               <div class="d-flex mt-3 justify-content-between">
                                                   ...
                                                   <div class="w-100">
                                                       ...
                                                       <label class="btn btn-sm btn-outline-success d-block"
                                                           for="Interested1"><i class="bi bi-check2-circle me-1"></i>
                                                           Interested</label>
                                                   </div>
                                                   <div class="dropdown ms-3">
                                                       ...
                                                       <ul class="dropdown-menu dropdown-menu-end"
                                                          ...
                                                          <li><a class="dropdown-item" href="#"> <i
                                                                           class="bi bi-check2-circle fa-fw pe-2"></i>Interested</a>
                                                               </li>
                                                               <li><a class="dropdown-item" href="#"> <i
                                                                           class="bi bi-x-circle fa-fw pe-2"></i>Not
                                                                       interested</a></li>
                                                               <li><a class="dropdown-item" href="#"> <i
                                                                           class="bi bi-dash-circle fa-fw pe-2"></i>Maybe</a>
                                                               </li>
                                                       </ul>
                                                   </div>
                                               </div>
                                           ...
                                           <div class="card-body position-relative pt-0">
                                               ...
                                               <div class="d-flex mt-3 justify-content-between">
                                                   ...
                                                   <div class="w-100">
                                                       <input type="checkbox" class="btn-check d-block"
                                                           id="Interested1">
                                                       <label class="btn btn-sm btn-outline-warning d-block"
                                                           for="Interested1"><i class="bi bi-dash-circle me-1"></i>
                                                           Maybe</label>
                                                   </div>
                                                   <div class="dropdown ms-3">
                                                       <a href="#" class="btn btn-sm btn-primary-soft"
                                           ...
                                           <div class="card-body position-relative pt-0">
                                               ...
                                               <div class="d-flex mt-3 justify-content-between">
                                                   ...
                                                   <div class="w-100">
                                                       <input type="checkbox" class="btn-check d-block"
                                                           id="Interested1">
                                                       <label class="btn btn-sm btn-outline-danger d-block"
                                                           for="Interested1"><i class="bi bi-x-circle me-1"></i>
                                       ...
                                       <div class="card h-100">
                                           ...
                                           <div class="card-body position-relative pt-0">
                                               ...
                                               <a class="btn btn-xs btn-primary mt-n3" href="event-details.html">Live
                                                   show</a>
                                               <h6 class="mt-3"> <a href="event-details.html"> America 50th anniversary
                                                   </a> </h6>
                                               <!-- Date time -->
                                               ...
                                               <div class="d-flex mt-3 justify-content-between">
                                                   ...
                                                   <div class="w-100">
                                                       <input type="checkbox" class="btn-check d-block" id="Interested6"
                                                           checked="">
                                                       <label class="btn btn-sm btn-outline-success d-block"
                                                           for="Interested6"><i class="fa-solid fa-thumbs-up me-1"></i>
                                                           Interested</label>
                                                   </div>
                                                   <div class="dropdown ms-3">
                                                       <a href="#" class="btn btn-sm btn-primary-soft"
                                               ...
                                               <div class="d-flex mt-3 justify-content-between">
                                                   ...
                                                   <div class="w-100">
                                                       <input type="checkbox" class="btn-check d-block"
                                                           id="Interested7">
                                                       <label class="btn btn-sm btn-outline-success d-block"
                                                           for="Interested7"><i class="fa-solid fa-thumbs-up me-1"></i>
                                                           Interested</label>
                                                   </div>
                                                   <div class="dropdown ms-3">
                                                       <a href="#" class="btn btn-sm btn-primary-soft"
                                               ...
                                               <div class="d-flex mt-3 justify-content-between">
                                                   ...
                                                   <div class="w-100">
                                                       <input type="checkbox" class="btn-check d-block"
                                                           id="Interested8">
                                                       <label class="btn btn-sm btn-outline-success d-block"
                                                           for="Interested8"><i class="fa-solid fa-thumbs-up me-1"></i>
                                                           Interested</label>
                                                   </div>
                                                   <div class="dropdown ms-3">
                                                       <a href="#" class="btn btn-sm btn-primary-soft"
                                               ...
                                               <div class="d-flex mt-3 justify-content-between">
                                                   ...
                                                   <div class="w-100">
                                                       <input type="checkbox" class="btn-check d-block" id="Interested9"
                                                           checked="">
                                                       <label class="btn btn-sm btn-outline-success d-block"
                                                           for="Interested9"><i class="fa-solid fa-thumbs-up me-1"></i>
                                                           Interested</label>
                                                   </div>
                                                   <div class="dropdown ms-3">
                                                       <a href="#" class="btn btn-sm btn-primary-soft"
