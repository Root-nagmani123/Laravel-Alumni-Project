    <!--==================================================================-->
    <script src="{{asset('feed_assets/js/plugins/jquery.min.js')}}"></script>
    <script src="{{asset('feed_assets/js/bootstrap.bundle.min.js')}}"></script>
    ...
    <script src="https://img1.digitallocker.gov.in/ux4g/UX4G-CDN-accessibility/js/weights-v1.js"></script><script nonce="{{ $cspNonce }}">    document.getElementById('uw-widget-custom-trigger2').addEventListener('click', function() {    openMain();  });</script>                                                                                     